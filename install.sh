...
pip install transformers bitsandbytes accelerate deepspeed rwkv mamba pytorch-lightning gradio streamlit datasets diffusers numpy safetensors sentencepiece
